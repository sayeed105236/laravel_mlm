<div class="modal-size-default d-inline-block">
    ...
    <!-- Modal -->
    <div class="modal fade text-left" id="walletTransfer" tabindex="-1" role="dialog" aria-labelledby="myModalLabel18"
         aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="card-body">
                        ...
                        <form id="jquery-val-form" action="{{route('wallet-transfer')}}" method="post">
                            @csrf
